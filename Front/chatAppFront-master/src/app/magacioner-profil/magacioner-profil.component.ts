...
@Component({
  selector: 'app-magacioner-profil',
  templateUrl: './magacioner-profil.component.html',
  styleUrls: ['./magacioner-profil.component.css']
})
export class MagacionerProfilComponent implements OnInit {
  admin: any = [];
  korisnik: any = [];
